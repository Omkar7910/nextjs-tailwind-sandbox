  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col justify-center items-center w-fit relative z-30">
        <div
          onClick={() => setOpen((prev) => !prev)}//open and close functionality
        ...
        >
          {cities.map((item) => (
            <div
              ...
              className={`flex justify-start items-center gap-x-2 px-2 py-1 hover:bg-blue-100 cursor-pointer ${
                selectedCity === item ? "bg-blue-100" : ""
              }`}
            >
              <AiOutlineCheck
                className={`text-darkblue-300 ${
